...
namespace Tms.Planning.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260426134543_AddOrderStopId_Fix")]
    partial class AddOrderStopId_Fix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tms.Planning.Domain.Entities.PlanningOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("CurrentProcessingSessionId")
                        .IsConcurrencyToken()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrderId", "OrderStopId")
                        .IsUnique();

                    b.ToTable("PlanningOrders", "pln");
                });
